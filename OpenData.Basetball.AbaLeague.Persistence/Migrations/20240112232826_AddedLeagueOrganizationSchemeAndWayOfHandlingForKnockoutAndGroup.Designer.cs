...
namespace OpenData.Basetball.AbaLeague.Persistence.Migrations
{
    ...
    [Migration("20240112232826_AddedLeagueOrganizationSchemeAndWayOfHandlingForKnockoutAndGroup")]
    partial class AddedLeagueOrganizationSchemeAndWayOfHandlingForKnockoutAndGroup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OpenData.Basketball.AbaLeague.Domain.Entities.LeagueGameLength", b =>
                {
                    b.Property<short>("GameLengthId")
                        .HasColumnType("smallint");

                    b.Property<int>("LeagueId")
                        .HasColumnType("int");

                    b.HasKey("GameLengthId", "LeagueId");

                    b.HasIndex("LeagueId");

                    b.ToTable("LeagueGameLengths");
                });

            modelBuilder.Entity("OpenData.Basketball.AbaLeague.Domain.Entities.LevelOfScale", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("OpenData.Basketball.AbaLeague.Domain.Entities.RangeScale", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<short>("LevelOfScaleId")
                        .HasColumnType("smallint");
                    ...
                    b.Property<short>("StatsPropertyId")
                        .HasColumnType("smallint");

                    b.HasKey("Id");

                    b.HasIndex("GameLengthId");

                    b.HasIndex("LevelOfScaleId");

                    b.HasIndex("StatsPropertyId");

                    b.ToTable("RangeScales");
                });
            ...
            modelBuilder.Entity("OpenData.Basketball.AbaLeague.Domain.Entities.LeagueGameLength", b =>
                {
                    b.HasOne("OpenData.Basketball.AbaLeague.Domain.Entities.GameLength", "GameLength")
                        .WithMany()
                        .HasForeignKey("GameLengthId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("OpenData.Basketball.AbaLeague.Domain.Entities.RangeScale", b =>
                {
                    ...
                    b.HasOne("OpenData.Basketball.AbaLeague.Domain.Entities.LevelOfScale", "LevelOfScale")
                        .WithMany()
                        .HasForeignKey("LevelOfScaleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OpenData.Basketball.AbaLeague.Domain.Entities.StatsProperty", "StatsProperty")
                        .WithMany()
                        .HasForeignKey("StatsPropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GameLength");

                    b.Navigation("LevelOfScale");

                    b.Navigation("StatsProperty");
                });

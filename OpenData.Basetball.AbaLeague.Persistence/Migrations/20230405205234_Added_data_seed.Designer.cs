...
namespace OpenData.Basetball.AbaLeague.Persistence.Migrations
{
    ...
    [Migration("20230405205234_Added_data_seed")]
    partial class Added_data_seed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OpenData.Basetball.AbaLeague.Domain.Entities.League", b =>
                {
                    ...
                    b.Property<string>("TeamParticipansUrl")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "Sys",
                            CreatedDate = new DateTime(2023, 4, 3, 20, 52, 34, 672, DateTimeKind.Utc).AddTicks(4481),
                            ...
                            UpdateBy = "Sys",
                            UpdatedDate = new DateTime(2023, 4, 5, 18, 52, 34, 672, DateTimeKind.Utc).AddTicks(4496)
                        },
                        new
                        {
                            Id = 2,
                            CreatedBy = "Sys",
                            CreatedDate = new DateTime(2023, 4, 3, 20, 52, 34, 672, DateTimeKind.Utc).AddTicks(4511),
                            ...
                            TeamParticipansUrl = "ur2",
                            UpdateBy = "Sys",
                            UpdatedDate = new DateTime(2023, 4, 5, 18, 52, 34, 672, DateTimeKind.Utc).AddTicks(4512)
                        });
                });
            ...
            modelBuilder.Entity("OpenData.Basetball.AbaLeague.Domain.Entities.Player", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryId = 1,
                            CreatedBy = "Sys",
                            CreatedDate = new DateTime(2023, 4, 3, 20, 52, 34, 672, DateTimeKind.Utc).AddTicks(6660),
                            DateOfBirth = new DateTime(1991, 4, 5, 20, 52, 34, 672, DateTimeKind.Utc).AddTicks(6652),
                            Height = 193,
                            Name = "Dragan Milosavljevic",
                            Nationality = "Serbian",
                            PositionId = (short)2,
                            UpdateBy = "Sys",
                            UpdatedDate = new DateTime(2023, 4, 5, 18, 52, 34, 672, DateTimeKind.Utc).AddTicks(6662)
                        },
                        new
                        {
                            Id = 2,
                            CountryId = 3,
                            CreatedBy = "Sys",
                            CreatedDate = new DateTime(2023, 4, 3, 20, 52, 34, 672, DateTimeKind.Utc).AddTicks(6675),
                            DateOfBirth = new DateTime(1987, 4, 5, 20, 52, 34, 672, DateTimeKind.Utc).AddTicks(6673),
                            Height = 210,
                            Name = "Miro Bilan",
                            Nationality = "Croatian",
                            PositionId = (short)5,
                            UpdateBy = "Sys",
                            UpdatedDate = new DateTime(2023, 4, 5, 18, 52, 34, 672, DateTimeKind.Utc).AddTicks(6676)
                        },
                        new
                        {
                            Id = 3,
                            CountryId = 1,
                            CreatedBy = "Sys",
                            CreatedDate = new DateTime(2023, 4, 3, 20, 52, 34, 672, DateTimeKind.Utc).AddTicks(6680),
                            DateOfBirth = new DateTime(2002, 4, 5, 20, 52, 34, 672, DateTimeKind.Utc).AddTicks(6678),
                            Height = 201,
                            Name = "Uros Trifunovic",
                            Nationality = "Serbian",
                            PositionId = (short)3,
                            UpdateBy = "Sys",
                            UpdatedDate = new DateTime(2023, 4, 5, 18, 52, 34, 672, DateTimeKind.Utc).AddTicks(6680)
                        });
                });
            ...
            modelBuilder.Entity("OpenData.Basetball.AbaLeague.Domain.Entities.Team", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CountryId = 1,
                            CreatedBy = "Sys",
                            CreatedDate = new DateTime(2023, 4, 3, 20, 52, 34, 673, DateTimeKind.Utc).AddTicks(4059),
                            Name = "Partizan",
                            ShortCode = "PAR",
                            UpdateBy = "Sys",
                            UpdatedDate = new DateTime(2023, 4, 5, 18, 52, 34, 673, DateTimeKind.Utc).AddTicks(4061),
                            Venue = "Arena"
                        },
                        new
                        {
                            ...
                            CountryId = 2,
                            CreatedBy = "Sys",
                            CreatedDate = new DateTime(2023, 4, 3, 20, 52, 34, 673, DateTimeKind.Utc).AddTicks(4073),
                            Name = "Igokea",
                            ShortCode = "IGO",
                            UpdateBy = "Sys",
                            UpdatedDate = new DateTime(2023, 4, 5, 18, 52, 34, 673, DateTimeKind.Utc).AddTicks(4074),
                            Venue = "Dom sportova"
                        });
                });
